...
<img width="640" alt="image" src="https://github.com/agiga-quanta/Translation-is-fun/blob/main/images/Welcome%20page%20red%20circle.png">
...
`ChatGPT` only gave 2 types of outputs, "Relevant" and "Not Relevant". This is not helpful at all.
...
`ChatGPT` only gave 2 outputs, Relevant" and "Not Relevant". This is not helpful again.
